...
extension String {
    ...
    ///
    /// - Returns: true
    func isValidLetterAndNumeral() -> Bool {
//        let password: NSString = self as NSString
//        let isValid = password.jk_isValid(withMinLenth: 6, maxLenth: 20, containChinese: false, containDigtal: true, containLetter: true, containOtherCharacter: password as String!, firstCannotBeDigtal: false)
//        return isValid
        
        let pattern = "^(?![0-9]+$)(?![a-zA-Z]+$)(?![`_~!@#\\$%\\^&*\\(\\)\\-\\+<>\\?:\\\"{},\\./\\;'\\[\\]\\\\.]+$)[0-9A-Za-z`_~!@#\\$%\\^&*\\(\\)\\-\\+<>\\?:\\\"{},\\./\\;'\\[\\]\\\\.]{6,20}$"
